...
* Konkrete Anwendungsformate von PICA werden als [Anwendungsprofile](#sec-anwendungsprofile) durch semi-formale Katalogisierungsrichtlinien oder mittels formaler [Avram-Schemas](#avram-schemas) festgelegt.

## Grundsätzlicher Aufbau {#sec-pica-struktur}
...
::: {#lst-ini lst-cap="Fiktiver PICA-Datensatz in PICA Plain und als INI-Datei"}
...
[Avram]: pica-formate.qmd#avram-schemas
...
## Anwendungsprofile {#sec-anwendungsprofile}
...
```{#lst-avram .json lst-cap="Beispiel für ein Avram-Schema mit Definition des K10plus-Feldes für die ISBN"}
