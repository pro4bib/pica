...
* Das Kommandozeilenprogramm picadata (@sec-picadata)
* Das Datenverarbeitungs-Werkzeug Catmandu (@sec-catmandu)
* Das Kommandozeilenprogramm pica-rs (@sec-pica-rs)
...
* Die **Perl**-Programmbibliotheken [PICA::Data](https://github.com/gbv/PICA-Data), auf der sowohl picadata (@sec-picadata) als auch die PICA-Funktionen von Catmandu (@sec-catmandu) basiert (ein ältere, inzwischen nicht mehr weiterentwickelte Version der Bibliothek ist [PICA::Record](https://github.com/gbv/PICA-Record)).
